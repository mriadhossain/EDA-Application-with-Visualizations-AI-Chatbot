...
def data_preprocessing_page():
    ...
    if st.session_state.df is not None:
        ...
        with col2:
            ...
            if user_input and st.session_state.detailed_summary:
                st.write("Calling chatbot...")
                response = get_chatbot_response(user_input, st.session_state.detailed_summary, st.session_state.conversation_history)
                st.write(response)
